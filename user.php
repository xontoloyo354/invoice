...
<!-- Page Content -->
  <div class="container container-pusat">
    ...
    <button type="button" id="add_user" class="btn btn-info btn-sm mb-3">Tambah users</button>

    <!-- Users DataTable -->
    <div class="card mx-auto mb-4 border-info">
      <div class="card-header bg-info text-white">Tabel Users</div>
      <div class="card-body">
        ...
        <div class="modal-body">
          <form id="user_form">
            ...
            <div class="form-group">
              ...
              <input type="text" id="full_name" name="full_name" class="form-control" maxlength="100" autocomplete="off" placeholder="Masukkan Nama Lengkpa">
              <div id="full_name_error_message" class="text-danger"></div>
            </div>
            <div class="form-group">
              <label>E-mail <i class="text-danger">*</i></label>
              <input type="text" id="email" name="email" class="form-control" maxlength="100" autocomplete="off" placeholder="Masukkan E-mail">
            ...
            <div class="form-group">
              ...
              <input type="password" class="form-control" id="password" name="password" maxlength="50" placeholder="Masukkan Password">
            ...
            <div class="form-group">
              ...
              <input type="password" class="form-control" id="confirm_password" name="confirm_password" maxlength="50" placeholder="Masukkan Confirm password">
