<?php
	...
	class PDF extends FPDF {
		function Header(){
			...
			$this->Image('images/logo-lab.png',5,0,200);
			$this->Image('images/logo-azura.jpg',10,10,20);
			...
			$this->Cell(55,10,'NAMA ITEM',1,0,'',true);
			$this->Cell(15,10,'QTY',1,0,'',true);
			$this->Cell(30,10,'HARGA',1,0,'',true);
			$this->Cell(30,10,'PAJAK',1,0,'',true);
