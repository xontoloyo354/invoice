...
<body>
<div class="page-wrapper chiller-theme container-fluid">
  ...
  <nav id="sidebar" class="sidebar-wrapper">
    <div class="sidebar-content">
      ...
      <div class="sidebar-header">
        ...
        <div class="user-info">
          <span class="user-name"><strong><?php echo $_SESSION['user_full_name']; ?></strong>
      ...
      <div class="sidebar-menu">
        <ul>
          ...
          <li class="sidebar-dropdown" id="non-dropdown" >
            <a href="index.php">
          ...
          <li class="sidebar-dropdown">
            ...
            <div class="sidebar-submenu">
              <ul>
                <li>
                  <a href="create_invoice.php">Create Invoice

                  </a>
                </li>
                <li>
                  <a href="invoice.php">Manage Invoices</a>
                </li>
              </ul>
            </div>
          </li>
...
<!-- page-wrapper -->
    ...
    <script>
        jQuery(function ($) {
            ...
            $(".page-wrapper").removeClass("col-lg-4");
            $(".container").removeClass('col-lg-6');
            });
            $("#show-sidebar").click(function() {
            $(".page-wrapper").addClass("toggled");
            $(".page-wrapper").addClass("col-lg-4");
