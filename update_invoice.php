    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <h5 class="text-center">Apakah Anda yakin ingin membatalkan pembuatan Invoice saat ini?</h5>
        </div>
